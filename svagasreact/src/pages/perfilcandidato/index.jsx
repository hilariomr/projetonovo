...
function PerfilCandidato() {
  ...
  const tipoLogado = localStorage.getItem("tipo-usuario")
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:5000/api/Candidato/${idUsuario}`, getFecthInfo())
      .then(response => {
  ...
  return (
    <div className="perfil-candidato">
      ...
      <div className="header-perfil">
        ...
        <Link to="/perfil/candidato/editar"><button>Editar Perfil</button></Link>
        < Link id="buscarvagas"  to="/vagas">
